...
//printf( "\n" );
        ...
        // if > Required, print a warning
        if ( (int)Aig_Regular(pObjNew)->Level > Required )
            printf( "Warning: Node %d has level %d, which is greater than required level %d.\n", 
                    pObj->Id, Aig_Regular(pObjNew)->Level, Required );
